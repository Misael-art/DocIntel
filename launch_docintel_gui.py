            ...
            json.dumps(
                {
                    ...
                    "latest_plan_key": context.latest_plan_key,
                    "latest_plan_status": context.latest_plan_status,
                    "latest_plan_summary": context.latest_plan_summary,
                    "latest_validation_report": str(context.latest_validation_report) if context.latest_validation_report else None,
                },
                ensure_ascii=True,
                indent=2,
            )
